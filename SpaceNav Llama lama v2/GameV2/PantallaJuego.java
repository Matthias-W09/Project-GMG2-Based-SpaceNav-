...
public class PantallaJuego implements Screen {
	...
	public PantallaJuego(SpaceNavigation game, int ronda, int vidas, int score,  
	    ...
	    nave = new Nave4(Gdx.graphics.getWidth()/2-50,30,new Texture(Gdx.files.internal("MainShip3.png")),
            ...
            Random r = new Random();
    ArrayList<Ball2> tempBalls = new ArrayList<>(); // Lista temporal para verificar colisiones
    ...
    for (int i = 0; i < cantAsteroides; i++) {
        ...
        do {
            ...
            newBall = new Ball2(x, y, size, velXAsteroides + r.nextInt(4), velYAsteroides + r.nextInt(4), new Texture(Gdx.files.internal("aGreyMedium4.png")));

            for (Ball2 ball : tempBalls) {
                if (newBall.getArea().overlaps(ball.getArea())) {
                    collision = true;
                    break;
                }
            }
